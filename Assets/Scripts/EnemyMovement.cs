...
public class EnemyMovement : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        waypoints = waypoints.OrderBy(obj => obj.name, new AlphanumComparatorFast()).ToArray();
        hpText = GameObject.FindGameObjectWithTag("Text").GetComponent<TMP_Text>();
    }
    private void Update()
    {
        ...
        {
            EnemySpawner.hp -= 1;
            hpText.text = "hp: " + EnemySpawner.hp.ToString();
            Destroy(gameObject);
        }
    }
}
